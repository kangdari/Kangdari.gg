const traits = [
  {
    ...
    type: "class",
    kr_name: "검사",
    kr_description: "검사는 기본 공격 시 일정 확률로 대상에게 두 번의 추가 공격을 가합니다. 추가 공격은 기본 공격 시의 피해를 입히며 적중 시 효과가 적용됩니다.",
    sets: [
      {
        style: "bronze",
        min: 3,
  ...
  },
  {
    ...
    type: "class",
    kr_name: "총잡이",
    kr_description: "총잡이는 네 번째 기본 공격마다 무작위 적에게 추가 공격을 가합니다. 추가 공격은 기본 공격 시의 피해를 입히며 적중 시 효과가 적용됩니다.",
    sets: [
      {
        style: "bronze",
        min: 2,
  ...
  },
  {
    ...
    name: "Demolitionist",
    description:
      "Damage from Demolitionists' spellcasts stuns their targets for a few seconds. (Once per spellcast)",
    type: "class",
    kr_name: "폭파광",
  ...
  },
  {
    ...
    name: "Infiltrator",
    innate:
      "At the start of combat, Infiltrators move to the enemy's backline.",
    description:
      "Infiltrators gain Attack Speed for a few seconds at the start of combat.",
    type: "class",
    kr_name: "잠입자",
  ...
  },
  {
    ...
    name: "Mana-Reaver",
    description:
      "Mana-Reavers' Basic Attacks increase the mana cost of their target's next spellcast by a percentage.",
    type: "class",
    kr_name: "마나 약탈자",
  ...
  },
  {
    ...
    type: "origin",
    kr_name: "메카 파일럿",
    kr_description: "슈퍼 메카의 체력과 공격력, 특성은 파일럿들의 능력치를 모두 합친 값과 같으며 파일럿들의 아이템 중 3개를 무작위로 장착합니다. 슈퍼 메카가 죽으면 파일럿들이 탈출해 전투를 계속합니다.",
    sets: [
      {
        style: "gold",
        min: 3,
  ...
  },
  {
    ...
    name: "Mercenary",
    innate:
      "Upgrades for Mercenaries' spells have a chance to appear in the shop.",
    type: "class",
    kr_name: "용병",
  ...
  },
  {
    ...
    name: "Sniper",
    description:
      "Snipers deal percentage increased damage for each hex between themselves and their target.",
    type: "class",
    kr_name: "저격수",
  ...
  },
  {
    ...
    type: "class",
    kr_name: "우주선",
    kr_innate: "고유: 우주선은 매초 마나를 40씩 획득하며 전장 주위를 돕니다. 이동 방해 효과에 면역이지만, 기본 공격은 할 수 없습니다.",
    sets: [
      {
        style: "gold",
        min: 1,
  ...
  },
  {
    ...
    name: "Valkyrie",
    description:
      "Valkyrie attacks and spells always critically hit targets below a percentage health.",
    type: "origin",
    kr_name: "발키리",
  ...
  
  {
    ...
    type: "origin",
    kr_name: "인도자",
    kr_description: "아군 별 수호자의 기본 공격이 입히는 피해가 고정 피해로 전환됩니다. 다른 아군은 기본 공격이 입히는 피해가 마법 피해로 전환됩니다.",
    sets: [
      {
        style: "gold",
        min: 1,
  ...
  
  {
    key: "",
    name: "Battlecast",
    description: "Battlecast champions, upon dealing or taking 10 instances of damage, trigger a bonus effect based on their current health. If they’re above half health, they deal 75/150/225 magic damage to the nearest enemy. If they’re below half health, they heal for 75/150/225 instead.",
    type: "origin",
    kr_name: "전투 기계",
    kr_description: "전투 기계 챔피언은 피해를 10회 입히거나 입으면 현재 체력에 따라 추가 효과를 적용받습니다. 체력이 절반 이상인 경우 가장 가까운 적에게 마법 피해를 입힙니다. 체력이 절반 이하인 경우 체력을 회복합니다.",
    sets: [
      {
        style: "bronze",
        min: 2,
